...
var SatisfactionGuarantee = React.createClass({displayName: "SatisfactionGuarantee",
  render: function() {
    return (
			React.createElement("div", {id: "sg"}, 
				React.createElement("strong", null, "Satisfaction Guarantee")
			)
    );
  }
});

React.render(React.createElement(SatisfactionGuarantee, null), document.getElementById('badge'));
